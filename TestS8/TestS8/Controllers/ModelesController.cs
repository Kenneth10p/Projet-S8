    ...
    public class ModelesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Modele != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Modele'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdModele,Accuracy,Hyperparametre,Nom")] Modele modele)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdModele,Accuracy,Hyperparametre,Nom")] Modele modele)
        {
