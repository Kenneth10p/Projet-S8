...
namespace TestS8.Data.Migrations
{
    ...
    [Migration("20240509204916_AddSimulation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestS8.Models.Plot", b =>
                {
                    ...
                    b.Property<int?>("ModeleIdModele")
                        .HasColumnType("int");

                    b.HasKey("IdPlot");

                    b.HasIndex("ModeleIdModele");
            ...
            modelBuilder.Entity("TestS8.Models.Modele", b =>
                {
                    b.HasOne("TestS8.Models.Simulation", null)
                        .WithMany("Modeles")
            ...
            modelBuilder.Entity("TestS8.Models.Plot", b =>
                {
                    b.HasOne("TestS8.Models.Modele", null)
                        .WithMany("Plots")
                        .HasForeignKey("ModeleIdModele");
                });
